    ...
    case WM_COMMAND:
        {
            ...
            case ID_TOOL_POINT:
            case ID_32771:
                editor->Start(new PointShape, hWnd, ID_TOOL_POINT, ID_32771, lParam);
                break;

            case ID_TOOL_LINE:
            case ID_32772:
                editor->Start(new LineShape, hWnd, ID_TOOL_LINE, ID_32772, lParam);
                break;

            case ID_TOOL_RECT:
            case ID_32773:
                editor->Start(new RectShape, hWnd, ID_TOOL_RECT, ID_32773, lParam);
                break;

            case ID_TOOL_ELLIPSE:
            case ID_32774:
                editor->Start(new EllipseShape, hWnd, ID_TOOL_ELLIPSE, ID_32774, lParam);
                break;

            case ID_TOOL_OOLINE:
            case ID_32775:
                editor->Start(new LineOOShape, hWnd, ID_TOOL_OOLINE, ID_32775, lParam);
                break;

            case ID_TOOL_CUBE:
            case ID_32776:
                editor->Start(new CubeShape, hWnd, ID_TOOL_CUBE, ID_32776, lParam);
                break;
